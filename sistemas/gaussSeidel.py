...
def executar_gauss_seidel():
    ...
    try:
        solucoes = gauss_seidel(A, b, x0, n, tolerancia, max_iteracoes)
...
def gauss_seidel(A, b, x0, n, tolerancia, max_iteracoes):
